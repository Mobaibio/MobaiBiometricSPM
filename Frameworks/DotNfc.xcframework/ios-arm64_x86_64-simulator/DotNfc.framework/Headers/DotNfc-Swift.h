...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nullable otherPersonDetails;
...
/// <code>MachineReadableZonePassword</code> - password from Machine Readable Zone.
/// <code>CardAccessNumberPassword</code> - Card Access Number.
SWIFT_PROTOCOL_NAMED("TravelDocumentReaderPassword")
@protocol DOTNTravelDocumentReaderPassword
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end


/// Card Access Number as a password.
SWIFT_CLASS_NAMED("CardAccessNumberPassword")
@interface DOTNCardAccessNumberPassword : NSObject <DOTNTravelDocumentReaderPassword>
/// Card Access Number in the 6-digits format.
@property (nonatomic, readonly, copy) NSString * _Nonnull value;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nullable instancetype)initWithValue:(NSString * _Nonnull)value error:(NSError * _Nullable * _Nullable)error OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
@class DOTNTravelDocumentReaderPasswordWrapper;
@class DOTNLdsMasterFile;

SWIFT_CLASS_NAMED("DebugInfo") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNDebugInfo : NSObject
@property (nonatomic, readonly, strong) DOTNTravelDocumentReaderPasswordWrapper * _Nullable password;
...
///
/// throws:
/// Throws an error if the <code>DotNfc</code> library is not enabled in the license.
- (BOOL)initializeWithLicense:(id <DotSdkLicenseProxyProtocol> _Nonnull)license error:(NSError * _Nullable * _Nullable)error;
/// Deinitialize library.
///
/// throws:
/// Throws an error if the <code>DotNfc</code> library fails to deinitialize.
...
SWIFT_CLASS_NAMED("FlatTagStructureParser") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNFlatTagStructureParser : NSObject
/// Parse flat tag structure and return (tag, value) pairs as a dictionary.
/// \param value Input data.
///
///
/// throws:
/// Throws an error if <code>value</code> has invalid structure.
///
/// returns:
...
SWIFT_CLASS_NAMED("MachineReadableZonePassword")
@interface DOTNMachineReadableZonePassword : NSObject <DOTNTravelDocumentReaderPassword>
...
/// NFC password created from document number, date of expiry and date of birth of MRZ.
SWIFT_CLASS_NAMED("NfcKey") SWIFT_DEPRECATED_MSG("Use classes of `TravelDocumentReaderPassword` protocol instead.)") SWIFT_AVAILABILITY(ios,introduced=13)
...
///
/// \param activeAuthenticationChallenge Random 8 bytes. If the Active Authentication challenge is set,
/// Active Authentication protocol will be used for the authentication of the chip (if supported by the chip).
/// Response (signature) will be returned in the result of the read operation. This response should be validated
/// by the application server to verify the authenticity of the chip. In case when the Active Authentication
/// protocol is not supported by the chip, the chip will be authenticated the same way as if the argument
/// <code>activeAuthenticationChallenge</code> is not set.
///
- (void)readWithNfcKey:(DOTNNfcKey * _Nonnull)nfcKey activeAuthenticationChallenge:(NSData * _Nullable)activeAuthenticationChallenge SWIFT_DEPRECATED_MSG("Use method `read(password: TravelDocumentReaderPassword, activeAuthenticationChallenge: Data? = nil)` instead.)");
/// Read passport using NFC password.
/// You can handle success or failure of NFC reading by implementing the delegate methods.
/// \param password Password for accessing the chip.
///
/// \param activeAuthenticationChallenge Random 8 bytes. If the Active Authentication challenge is set,
/// Active Authentication protocol will be used for the authentication of the chip (if supported by the chip).
/// Response (signature) will be returned in the result of the read operation. This response should be validated
...
/// <code>activeAuthenticationChallenge</code> is not set.
///
- (void)readWithPassword:(id <DOTNTravelDocumentReaderPassword> _Nonnull)password activeAuthenticationChallenge:(NSData * _Nullable)activeAuthenticationChallenge;
@end
...
@class NSURL;
enum DOTNNfcTravelDocumentReaderConfigurationPollingOption : NSInteger;
...
/// Specify polling option. Default is <code>standard</code>.
@property (nonatomic, readonly) enum DOTNNfcTravelDocumentReaderConfigurationPollingOption pollingOption;
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithAuthorityCertificatesUrl:(NSURL * _Nullable)authorityCertificatesUrl pollingOption:(enum DOTNNfcTravelDocumentReaderConfigurationPollingOption)pollingOption sessionToken:(NSString * _Nullable)sessionToken _debugInfoEnabled:(BOOL)_debugInfoEnabled OBJC_DESIGNATED_INITIALIZER;
@end

/// Polling option specifies which travel documents can be detected.
typedef SWIFT_ENUM_NAMED(NSInteger, DOTNNfcTravelDocumentReaderConfigurationPollingOption, "PollingOption", open) {
/// Standard polling option which supports detection of almost all travel documents.
  DOTNNfcTravelDocumentReaderConfigurationPollingOptionStandard = 0,
/// Experimental polling option which supports detection of newer <code>PACE</code> only travel documents.
/// This polling option supports detection of only newer <code>PACE</code> only travel documents and does not support detection of other travel documents.
/// This polling option is available on iOS 16 and newer. On older versions of iOS this option will default to <code>PollingOption.standard</code>.
  DOTNNfcTravelDocumentReaderConfigurationPollingOptionExperimental = 1,
};
...
SWIFT_CLASS_NAMED("AccessControlError") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNNfcTravelDocumentAccessControlError : DOTNNfcTravelDocumentReaderError
@end


/// If authentication of the chip using the Chip Authentication protocol fails. Secure connection was not established.
SWIFT_CLASS_NAMED("ChipAuthenticationError") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNNfcTravelDocumentChipAuthenticationError : DOTNNfcTravelDocumentReaderError
@end


/// If NFC reading fails due to an NFC tag connection failure.
SWIFT_CLASS_NAMED("NotConnectedError") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNNfcTravelDocumentNotConnectedError : DOTNNfcTravelDocumentReaderError
@end

@class DOTNNfcTravelDocumentReaderResult;
...
@protocol DOTNNfcTravelDocumentReaderDelegate
/// Tells the delegate that NFC reading has finished successfully with a result.
- (void)nfcTravelDocumentReader:(DOTNNfcTravelDocumentReader * _Nonnull)nfcTravelDocumentReader succeeded:(DOTNNfcTravelDocumentReaderResult * _Nonnull)result;
...
SWIFT_CLASS_NAMED("NfcTravelDocumentReaderResult") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNNfcTravelDocumentReaderResult : NSObject
/// Machine Readable Travel Document (eMRTD).
@property (nonatomic, readonly, strong) DOTNTravelDocument * _Nonnull travelDocument;
/// Binary content for server-side evaluation.
@property (nonatomic, readonly, copy) NSData * _Nonnull content;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithTravelDocument:(DOTNTravelDocument * _Nonnull)travelDocument content:(NSData * _Nonnull)content OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
...
SWIFT_CLASS_NAMED("TravelDocumentReaderPasswordWrapper") SWIFT_AVAILABILITY(ios,introduced=13)
@interface DOTNTravelDocumentReaderPasswordWrapper : NSObject
@property (nonatomic, readonly, strong) id <DOTNTravelDocumentReaderPassword> _Nonnull travelDocumentReaderPassword;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithTravelDocumentReaderPassword:(id <DOTNTravelDocumentReaderPassword> _Nonnull)travelDocumentReaderPassword OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
@end
