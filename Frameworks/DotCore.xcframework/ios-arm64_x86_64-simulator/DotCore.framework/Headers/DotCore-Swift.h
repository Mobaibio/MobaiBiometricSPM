...
/// Return a copy of the <code>BgrRawImage</code> as a <code>BgraRawImage</code> object.
/// \param bgrRawImage Input image as a <code>BgrRawImage</code> object.
///
///
/// returns:
/// New <code>BgraRawImage</code> instance.
+ (DOTBgraRawImage * _Nonnull)createWithBgrRawImage:(DOTBgrRawImage * _Nonnull)bgrRawImage SWIFT_WARN_UNUSED_RESULT;
@end
...
+ (CIImage * _Nonnull)createWithBgraRawImage:(DOTBgraRawImage * _Nonnull)bgraRawImage SWIFT_WARN_UNUSED_RESULT;
...
/// <code>DotNfcLibrary</code> identifier.
  DotLibraryIdNfc = 3,
/// <code>DotPalmLibrary</code> identifier.
  DotLibraryIdPalm = 4,
};

@class DotSdkConfiguration;

/// Class responsible for the initialization of DOT libraries - <code>DotFace</code>, <code>DotFaceLite</code>, <code>DotDocument</code>, <code>DotNfc</code>, <code>DotPalm</code>.
...
///
/// throws:
/// Throws an error if <code>DotSdk</code> fails to decode provided license or if any <code>DotLibrary</code> fails to initialize.
- (BOOL)initializeWithConfiguration:(DotSdkConfiguration * _Nonnull)configuration error:(NSError * _Nullable * _Nullable)error;
/// Initialize license data for further per <code>DotSdk</code> library initialization.
...
///
/// \param transactionCountingToken Transaction counting token.
///
///
/// throws:
/// Throws an error if <code>DotSdk</code> fails to decode the <code>licenseBytes</code>.
- (BOOL)_initializeWithLicenseBytes:(NSData * _Nonnull)licenseBytes transactionCountingToken:(NSString * _Nullable)transactionCountingToken error:(NSError * _Nullable * _Nullable)error;
...
///
/// throws:
/// Throws an error if <code>_initialize(licenseBytes:)</code> was not called or if the <code>library</code> fails to initialize.
...
///
/// throws:
/// Throws an error if <code>DotSdk</code> fails to deinitialize.
- (BOOL)deinitializeAndReturnError:(NSError * _Nullable * _Nullable)error;
...
@property (nonatomic, readonly, copy) NSString * _Nullable transactionCountingToken;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithLicenseBytes:(NSData * _Nonnull)licenseBytes libraries:(NSArray<id <DotLibrary>> * _Nonnull)libraries transactionCountingToken:(NSString * _Nullable)transactionCountingToken OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly) BOOL isRealTimeAnalyticsReportingEnabled;
...
@property (nonatomic, readonly) BOOL isPalmEnabled;
@end
...
@property (nonatomic, readonly) NSInteger longerSide;
...
/// Two dimensional point with <code>Int</code> value type.
SWIFT_CLASS_NAMED("PointInt")
@interface DOTPointInt : NSObject
/// X coordinate.
...
@interface DOTPointInt (SWIFT_EXTENSION(DotCore))
+ (DOTPointInt * _Nonnull)fromCgPoint:(CGPoint)cgPoint SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) CGPoint cgPoint;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DOTRectangleDouble * _Nonnull zeroRectangle;)
+ (DOTRectangleDouble * _Nonnull)zeroRectangle SWIFT_WARN_UNUSED_RESULT;
+ (DOTRectangleDouble * _Nonnull)fromCgRect:(CGRect)cgRect SWIFT_WARN_UNUSED_RESULT;
@end


/// Rectangle area defined by the edges with <code>Int</code> value type.
SWIFT_CLASS_NAMED("RectangleInt")
@interface DOTRectangleInt : NSObject
/// Left edge.
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (nonnull instancetype)initWithLeft:(NSInteger)left top:(NSInteger)top right:(NSInteger)right bottom:(NSInteger)bottom OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) NSUInteger hash;
@end
...
@interface DOTRectangleInt (SWIFT_EXTENSION(DotCore))
@property (nonatomic, readonly) NSInteger width;
@property (nonatomic, readonly) NSInteger height;
@property (nonatomic, readonly) double widthToHeightRatio;
@property (nonatomic, readonly, strong) DOTPointInt * _Nonnull origin;
@property (nonatomic, readonly) CGRect cgRect;
+ (DOTRectangleInt * _Nonnull)fromCgRect:(CGRect)cgRect SWIFT_WARN_UNUSED_RESULT;
@end
